 ...
 * 
 */
public class NCB extends ComprobanteFiscal {
	
	/**
	 * <b>NO APTA PARA FACTURACI&Oacute;N ELECTR&Oacute;NICA MASIVA</b><br>
	 * Crea un Objeto de tipo Nota de Cr&eacute;dito B<br>
	 */
	public NCB(){
		super();
	}
	...
	/**
	 * <b>NO APTA PARA FACTURACI&Oacute;N ELECTR&Oacute;NICA MASIVA</b><br>
	 * Crea un Objeto de tipo Nota de Cr&eacute;dito B listo para autorizar electr&oacute;nicamente<br>
	 ...
	 */
	public NCB(Cuit cuitFacturador, 
		...
		super();
		this.setTipo(TipoComprobante.NOTA_CREDITO_B);
	...
	/**
	 * Crea un Objeto de tipo Nota de Cr&eacute;dito B listo para adjuntar a una lote de facturas del mismo tipo <br>
	 ...
	 * @throws EsphoraInternalException
	 */
	public NCB(TipoDocumento tipoDocCliente,
			Identification docCliente,
			TipoConcepto tipoConcepto, 
			Importe importe) throws EsphoraInternalException{
		super();
