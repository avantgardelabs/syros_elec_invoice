 ...
 * 
 */
public class NCA extends ComprobanteFiscal {
	
	/**
	 * <b>NO APTA PARA FACTURACI&Oacute;N ELECTR&Oacute;NICA MASIVA</b><br>
	 * Crea un Objeto de tipo Nota de Cr&eacute;dito A<br>
	 */
	public NCA(){
		super();
	}
	...
	/**
	 * <b>NO APTA PARA FACTURACI&Oacute;N ELECTR&Oacute;NICA MASIVA</b><br>
	 * Crea un Objeto de tipo Nota de Cr&eacute;dito A listo para autorizar electr&oacute;nicamente<br>
	 ...
	 */
	public NCA(Cuit cuitFacturador, 
		...
		super();
		this.setTipo(TipoComprobante.NOTA_CREDITO_A);
	...
	/**
	 * Crea un Objeto de tipo Nota de Cr&eacute;dito A listo para adjuntar a una lote de facturas del mismo tipo <br>
	 ...
	 * @throws EsphoraInternalException
	 */
	public NCA(TipoDocumento tipoDocCliente,
			Identification docCliente,
			TipoConcepto tipoConcepto, 
			Importe importe) throws EsphoraInternalException{
		super();
